  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active" style="color:black">
        <a class="nav-link" href="/NGO-Website-master/login.php" >Login<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="/NGO-Website-master/register.php" class='active'>Register</a>
      </li>
      <li class="nav-item ">
    ...
    <div class="container my-4">
     ...
     <form action="/NGO-Website-master/login.php" method="post">
